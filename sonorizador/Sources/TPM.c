...
void TPM0TPM1_PTE21_config_basica () {
	
	 //Habilita os sinais de relógio para TPM0 e TPM1 
	SIM_SCGC6 |= (SIM_SCGC6_TPM0_MASK |		// Habilita o clock de TPM0
		SIM_SCGC6_TPM1_MASK);				// Habilita o clock de TPM1

	//Habilitar os sinais de relogio para PORTE	 
	SIM_SCGC5 |= (SIM_SCGC5_PORTE_MASK);				//Habilita clock de PORTE
	
	//Configura pinos
	PORTE_PCR21 &= ~PORT_PCR_MUX_MASK;
