 ...
 * @param[in] Se igual a 1, a insercao gera uma impressao no LCD. Se igual a 0, a insercao e feita sem impressao no LCD
 * @param[in] Se igual a 1, a insercao gera alteracao no buzzzer. Se igual a 0, a insercao e feita sem alteracao no buzzer
 * @return 0 se a insercao for bem-sucedida, -1 caso contrario
 */
uint8_t BP_add (BufferPilha_type *buffer, char item, uint8_t print, uint8_t buzzeUp);

/**
 * @brief Apaga um elemento na pillha
 * @param[in] buffer apontador para a pilha na qual deseja-se inseri o elemento
 * @param[in] Se igual a 1, o apagamento gera uma impressao no LCD. Se igual a 0, o apagamento e feita sem impressao no LCD
 * @param[in] Se igual a 1, o apagamento gera alteracao no buzzzer. Se igual a 0, o apagamento e feita sem alteracao no buzzer
